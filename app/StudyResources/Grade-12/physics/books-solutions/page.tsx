...
import { maths, physics } from '@/data/classes/12';
import BackButton from '@/app/components/backbtn';

export default function PhysicsBooks() {
  ...
  return (
    <div className="p-6 text-center">
      <BackButton/>
      <h1 className="text-3xl font-bold text-white mb-8 mt-8 ">Grade 10 Physics Extra Books & Solutions</h1>
