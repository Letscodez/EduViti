...
export default function Grade9MathsPYQP() {
  
  return (
    <main className="p-6">
      <BackButton/>
      <h1 className="text-2xl sm:text-4xl font-bold text-center text-white mb-8 mt-10">Grade 9 <span className='text-primary'>Maths</span> PYQP's</h1>
